...
//parseInt("12px") => 12    parseInt("Hello12.5") =>  Nan   parseInt(+12.5Hello) => "+12.5"(преобразование в строку) => без radix считает по десятичной системе исчисления => +12
...
// parseFloat игнорит все символы, за исключением 0-9, -1 +2 12.5 e**n(экспонент в стемени n)
