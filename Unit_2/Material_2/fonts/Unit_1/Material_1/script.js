...
c.innerHTML = 6666;
//ну а в плюсе то получается, что строка преобразует любое число в строку в итоге, остальные знаки, там если числа даже в строке, то они преобразуются в числа.
// НО, если строка число в плюсе, то будет преобразование в число только в случае ее нахождения в начале.