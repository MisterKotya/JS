...
document.querySelector('.four').innerHTML += '<h4>Something</h4><p>Lorem</p>';
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.out-16').innerHTML = x1+x2 ; // Hello5 - потому что начинается со строчного элемента
