...
function f3() {
    let valueOf_1 = +input3_1.value;
    let valueOf_2 = +input3_2.value;
    if (valueOf_1 > valueOf_2) {
        output3.innerHTML = valueOf_1;
    }
    else {
        output3.innerHTML = valueOf_2;
    }
}
...
function f7() {
    let valueOf_1 = +input7_1.value;
    let valueOf_2 = +input7_2.value;
    let a = Math.pow(valueOf_1, valueOf_2);
    if (a) {
        output7.innerHTML = a;
    }
}
...
function f10() {
let num = +input10.value;
switch(num) {
        case 6:
        output10.innerHTML= 6;
        break;
        case 7:
        output10.innerHTML= 7;
        break;
        case 11:
        output10.innerHTML= 11;
        break;
        case 9:
        output10.innerHTML= 9;
        break;
}
}
...
function f11() {
    let num = +input11.value;
    switch(num) {
            case 6:
            output11.innerHTML= 6;
            break;
            case 7:
            output11.innerHTML= 7;
            break;
            case 11:
            output11.innerHTML= 11;
            break;
            case 9:
            output11.innerHTML= 9;
            break;
    }
    }
